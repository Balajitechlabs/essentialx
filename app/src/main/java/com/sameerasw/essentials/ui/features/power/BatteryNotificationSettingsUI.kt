 ...
 * License: MIT License
 *
 * Feature Module: Power & Battery Features
 * File: BatteryNotificationSettingsUI.kt
 * Description: Composable screen for configuring low/full battery notifications.
 */
