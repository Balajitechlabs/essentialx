 ...
 * File: FreezeManager.kt
 * Description: Utility helper for FreezeManager.kt.
 */
...
object FreezeManager {
    ...
    private fun isAppStreamingMedia(
        context: Context,
        packageName: String,
    ): Boolean {
        try {
    ...
    private fun hasOngoingNotification(
        context: Context,
        packageName: String,
    ): Boolean {
        try {
    ...
    private fun setAppSuspendedWithShizuku(
        packageName: String,
        suspended: Boolean,
    ): Boolean {
        return try {
    ...
    private fun setAppRestrictedWithShizuku(
        packageName: String,
        restricted: Boolean,
    ) {
        val appops =
    ...
    private fun getSuspenderPackage(): String = if (Shizuku.getUid() == 0) "com.sameerasw.essentials" else "com.android.shell"
