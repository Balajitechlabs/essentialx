 ...
 * File: StayAwakeTileService.kt
 * Description: Background service component for StayAwakeTileService.kt.
 */
...
class StayAwakeTileService : BaseTileService() {
    ...
    override fun getTileSubtitle(): String =
        if (getTileState() == Tile.STATE_ACTIVE) {
    ...
    override fun getTileIcon(): Icon = Icon.createWithResource(this, R.drawable.rounded_av_timer_24)
}
