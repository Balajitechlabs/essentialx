 ...
 * File: AdaptiveBrightnessTileService.kt
 * Description: Background service component for AdaptiveBrightnessTileService.kt.
 */
...
class AdaptiveBrightnessTileService : BaseTileService() {
    ...
    override fun getTileSubtitle(): String =
        if (isAdaptiveBrightnessEnabled()) getString(R.string.tile_active) else getString(R.string.tile_inactive)

    override fun hasFeaturePermission(): Boolean = PermissionUtils.canWriteSystemSettings(this)

    override fun getTileIcon(): Icon? =
        if (isAdaptiveBrightnessEnabled()) {
    ...
    override fun getTileState(): Int = if (isAdaptiveBrightnessEnabled()) Tile.STATE_ACTIVE else Tile.STATE_INACTIVE
