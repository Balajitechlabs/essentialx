 ...
 * File: VolumeLongPressDetector.kt
 * Description: Component file for VolumeLongPressDetector.kt.
 */
...
class VolumeLongPressDetector(
                ...
                try {
                    while (isRunning.get() && isActive) {
                        ...
                        when (event.code) {
                            ...
                            InputEventReader.KEY_VOLUMEDOWN ->
                                handleButton(
    ...
    private suspend fun handleButton(
        ...
        if (pressed) {
            ...
            val job =
                listeningScope?.launch(Dispatchers.IO) {
